  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              Hi, I'm{' '}
              <span className="gradient-text">Praise Bucuzong Bah</span>
            </motion.h1>
            ...
            >
              Software Engineer | Backend/API Developer | AI Engineer
            </motion.h2>
            ...
            <motion.p
              ...
              className="text-2xl md:text-3xl font-heading font-semibold text-text-primary mb-6"
            >
              Building Intelligent Systems.
              <br />
              <span style={{ color: '#A0522D' }}>Powering Real-World Solutions.</span>
            </motion.p>
            ...
            >
              A dynamic Software Engineering student specializing in backend systems, 
              APIs, mobile apps, and AI-driven solutions. Transforming ideas into 
          ...
          >
            <div className="relative">
              ...
              {/* Image container - Full rectangular */}
              <motion.div
                className="relative"
                animate={{ y: [0, -10, 0] }}
                transition={{
              ...
              >
                <div 
                  ...
                  style={{ background: 'linear-gradient(to right, #A0522D, #E8DCC8, #A0522D)' }}
                >
                  <div className="overflow-hidden rounded-xl bg-primary">
                    <img
                      src="/profile.jpg"
                      alt="Praise Bucuzong Bah"
      ...
      >
        ...
        >
          <ArrowDown style={{ color: '#E8DCC8' }} size={24} />
        </motion.div>
      </motion.div>
    </section>
  );
